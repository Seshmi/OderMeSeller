...
<%@page import="seller.additem.Item"%>
<%@page import="seller.additem.Itemdatadb"%>
<!DOCTYPE html>
<html>
<head>
...
<form class="wrapper" action="<%= request.getContextPath() %>/SearchitemServlet" method="post">
	<input type="text" class="input" placeholder="What are you looking for?" name="itemname">
...
<div class="slider-frame">
	<div class="slide-images">
		<div class="img-container">
			<img src="pic/fram1.png" width="1200px" height="400px">
				</div>
				<div class="img-container">
				<img src="pic/fram2.jpg" width="1200px" height="400px">
			</div>
			<div class="img-container">
			<img src="pic/fram3.jpg" width="1200px" height="400px">
		</div>
	</div>
</div>
